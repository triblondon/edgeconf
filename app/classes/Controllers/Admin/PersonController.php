...
class PersonController extends \Controllers\Admin\AdminBaseController {
	...
	public function post() {
		...
		if ($this->person) {
			...
			$res = $this->app->db->query('INSERT IGNORE INTO people SET {given_name}, {family_name}, {email}, {org}, {bio}, {travel_origin}', $data);
			$this->person = $this->req->getPost();
			$this->person['id'] = $res->getInsertId();
			$action = 'created';
		}
